class ConfirmationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @confirmation.save
        format.html { redirect_to root_path, notice: 'Muito obrigado! Sua presença está confirmada!' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to confirmations_url, notice: 'A confirmação foi apagada!' }
